import { sandwichMercadoLibre } from "../JSON/SandwichMercadoLibre.js";
import { contenedorMain, hojaImpresionContainer } from "../JSON/constantes.js";


export class ClaseMercadoLibre {
    renderMercadoLibre() {
        // Aquí puedes implementar la lógica para renderizar el contenido específico de Mercado Libre
        // Por ejemplo, podrías mostrar una lista de productos o cualquier otra información relevante.
        contenedorMain.innerHTML = `
                   <section id="recetas-lista">
                       ${sandwichMercadoLibre.map(receta => `
             ...
             contenedorMain.appendChild(hojaImpresionContainer);
                ...
                actualizarHojaImpresion() {
                    ...
                    inputs.forEach(input => {
                        ...
                        const receta = sandwichMercadoLibre.find(r => r.Mercaderia === input.dataset.id);
                        if (!receta) return;
